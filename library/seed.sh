...
BOOKS=("The Metamorphosis,Franz Kafka,5" "1984,George Orwell,3" "A song of ice and fire,George R R Martin,7")
MEMBERS=("Richard Stallman" "Terry Davis" "Yacine Brahimi")
TRANSACTIONS=("1,1,date('now'),'issued'" "2,2,date('now'),'issued'" "3,3,date('now'),'issued'")
